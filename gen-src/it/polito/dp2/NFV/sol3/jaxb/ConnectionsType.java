 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.example.org/NfvDeployer}plink" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ConnectionsType {
     ...
     * This is why there is not a <CODE>set</CODE> method for the plink property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPlink().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PLPtype> getPlink() {
        if (plink == null) {
            plink = new ArrayList<PLPtype>();
        }
        return this.plink;
    }
